...
const firebaseConfig = {
    apiKey: "AIzaSyCU8l5WqWBpfrLcAGti0sRMKOEM75Pg4RE",
    authDomain: "keerthik-wsp20.firebaseapp.com",
    databaseURL: "https://keerthik-wsp20.firebaseio.com",
    projectId: "keerthik-wsp20",
    storageBucket: "keerthik-wsp20.appspot.com",
    messagingSenderId: "604505848637",
    appId: "1:604505848637:web:8eeafa78879b37cfd36354"
  };
  // Initialize Firebase
...
app.get('/test', (req, res)=> {
    const time = new Date().toString() // current time from server converted to string // servers time is read
    let page = `
...
app.get('/test2', (req, res) =>{
    res.redirect('https://www.uco.edu/')
})